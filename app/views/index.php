...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/fi-icons@1.0.0/dist/fi-icons.min.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="?view=autorizaciones" class="sidebar-link"><i class="fa fa-check-circle"></i><span>Autorizaciones</span></a>
            ...
            <div class="sidebar-footer collapsible">
